...
public class CalendarAdapter extends RecyclerView.Adapter<CalendarAdapter.ViewHolder>{
    ...
    OnDeleteClickListener calendarFragment;

    public CalendarAdapter(OnMealItemClickListener onMealItemClickListener, OnDeleteClickListener calendarFragment) {
                ...
                new AlertDialog.Builder(view.getContext())
                        ...
                        .setPositiveButton("Delete", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                calendarFragment.onDeleteClicked(mealsList.get(position));
                            }
                        })
